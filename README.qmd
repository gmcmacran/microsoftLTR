...
# Summary
This repo builds a boosted model focused on ranking with LightGPM on the Microsoft's Web30K dataset. Gain is directly optimized during training. At the top 10 scores, gain is .571 on unseen data. This is considerably higher than the publication this code is based on indicating improvements in source code after printing.
